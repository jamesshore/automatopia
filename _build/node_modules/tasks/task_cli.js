...
module.exports = class TaskCli {
	...
	/**
	 * Interpret command-line arguments, runs tasks, and display success or failure. "Failure" means a task threw an
	 * exception. To show a prettier failure, without the exception stack trace, throw {@link TaskError} rather than
	 * Error.
	 ...
	 *   specified.
	 */
	async runAsync(tasks, successMessage, failureMessage) {
		ensure.signature(arguments, [ Tasks, String, String ]);
		...
		try {
			...
			await tasks.runTasksAsync(taskNames);
