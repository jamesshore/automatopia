...
module.exports = class FileSystem {
	 ...
	 * @param {(sourceFile: string) => string | string[]} rewriteFn Given the path a file in the target directory (relative to the target root), return a new path, or multiple paths. Useful for e.g., converting 'dest/my_file.ts' to 'dest/my_file.js' and 'dest/my_file.js.map'.
	 * @returns {added: { source: string, target: string }[], removed: { source: string, target: string }[], changed: { source: string, target: string }} The files that have been added, removed, or changed.
	 */
